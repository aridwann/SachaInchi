    ...
    <div class="px-40 flex flex-1 justify-center py-5">
        ...
        @endif
            ...
            <div class="flex">
                ...
                <div>
                    <h1 class="text-white text-2xl font-bold leading-tight tracking-[-0.015em] px-4 text-left pb-3 pt-5">
                        {{ $product['name'] }}
                    </h1>
                    <h3 class="text-[#54D12B] bg-[#273620] text-3xl font-bold leading-tight tracking-[-0.015em] ms-4 px-6 py-4">
                            ...
                            <dd class="text-[#A3C299] sm:col-span-2">
                                <div class="flex items-center rounded border border-[#A3C299] w-30">
                                    ...
                                    <input type="number" id="Quantity" value="1" min="1"
                                        class="h-10 w-10 text-center sm:text-sm"
                                        readonly />
            ...
            <div>
                ...
                <p class="text-[#A3C299] text-base font-normal leading-normal pb-3 pt-1 px-4 text-justify">
                    Kacang Sacha Inchi kami dipanen dari kebun lokal di Desa Sehat, diolah secara tradisional untuk menjaga kualitas dan rasa alami.
                    Kaya akan omega-3, omega-6, dan protein, kacang ini adalah camilan sehat yang sempurna untuk Anda dan keluarga.
                </p>
            </div>
        </div>
    </div>
