    ...
    <div class="px-40 flex flex-1 justify-center py-5">
        <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div class="flex flex-wrap gap-2 p-4">
                <a class="text-[#8a7560] text-base font-medium leading-normal hover:underline" href="/products">Produk</a>
                <span class="text-[#8a7560] text-base font-medium leading-normal">/</span>
                <span class="text-[#181411] text-base font-medium leading-normal">{{ $product['name'] }}</span>
            </div>
